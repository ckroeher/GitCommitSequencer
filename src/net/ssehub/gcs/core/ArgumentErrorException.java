...
/**
 * This class represents the specific type of exception thrown if user-defined arguments passed as input at start-up are
 * not as expected. 
 * 
...
public class ArgumentErrorException extends Exception {
     ...
     */
    private static final long serialVersionUID = -1030600728435585298L;
    
    /**
     * Constructs a new {@link ArgumentErrorException} instance.
     * 
